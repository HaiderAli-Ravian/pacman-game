import { FIELD_SIZE, WallType } from "@/components/pacman/TypesAndSettings";
import { Wall } from "@/components/pacman/Wall";
      ...
      case "horizontal":
        return (
          <div
            ...
            style={{ width: `${FIELD_SIZE}px`, height: `${FIELD_SIZE / 2}px` }}
          ></div>
        );
      case "vertical":
        return (
          <div
            className="rounded-md bg-blue-600"
            style={{ width: `${FIELD_SIZE / 2}px`, height: `${FIELD_SIZE}px` }}
          ></div>
        );
      case "tl":
        return (
